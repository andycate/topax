...
const mat4 theta_coef_msin_1to4_ncos_1to4 = transpose(mat4(
...
const mat4 theta_coef_msin_1to4_ncos_5to8 = transpose(mat4(
...
const mat4 theta_coef_mcos_1to4_nsin_1to4 = transpose(mat4(
...
const mat4 theta_coef_mcos_1to4_nsin_5to8 = transpose(mat4(
...
// -------- R COEFFICIENTS ---------
const mat4 R_coef_msin_1to4_nsin_1to4 = transpose(mat4(
...
const mat4 R_coef_msin_5to8_nsin_1to4 = transpose(mat4(
...
const mat4 R_coef_msin_1to4_nsin_5to8 = transpose(mat4(
...
const mat4 R_coef_msin_5to8_nsin_5to8 = transpose(mat4(
...
const mat4 R_coef_mcos_1to4_ncos_1to4 = transpose(mat4(
...
const mat4 R_coef_mcos_5to8_ncos_1to4 = transpose(mat4(
...
const mat4 R_coef_mcos_1to4_ncos_5to8 = transpose(mat4(
...
const mat4 R_coef_mcos_5to8_ncos_5to8 = transpose(mat4(
...
// -------- Z COEFFICIENTS ---------
const mat4 Z_coef_mcos_1to4_nsin_1to4 = transpose(mat4(
...
const mat4 Z_coef_mcos_5to8_nsin_1to4 = transpose(mat4(
...
const mat4 Z_coef_mcos_1to4_nsin_5to8 = transpose(mat4(
...
const mat4 Z_coef_mcos_5to8_nsin_5to8 = transpose(mat4(
...
const mat4 Z_coef_msin_1to4_ncos_1to4 = transpose(mat4(
...
const mat4 Z_coef_msin_5to8_ncos_1to4 = transpose(mat4(
...
const mat4 Z_coef_msin_1to4_ncos_5to8 = transpose(mat4(
...
const mat4 Z_coef_msin_5to8_ncos_5to8 = transpose(mat4(
